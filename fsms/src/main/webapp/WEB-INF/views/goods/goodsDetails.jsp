                    ...
                    <div class="product__details__pic">
                        ...
                        <div class="product__details__pic__slider owl-carousel">
                            <img data-imgbigurl="img/product/details/product-details-2.jpg"
                                src="${contextPath }/resources/bootstrap/img/product/details/thumb-1.jpg" alt="">
                            <img data-imgbigurl="img/product/details/product-details-3.jpg"
                                src="${contextPath }/resources/bootstrap/img/product/details/thumb-2.jpg" alt="">
                            <img data-imgbigurl="img/product/details/product-details-5.jpg"
                                src="${contextPath }/resources/bootstrap/img/product/details/thumb-3.jpg" alt="">
                            <img data-imgbigurl="img/product/details/product-details-4.jpg"
                                src="${contextPath }/resources/bootstrap/img/product/details/thumb-4.jpg" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                        ...
                        <ul>
                        	<c:choose>
                        		<c:when test="!${goodsDto.goodsCnt }">
		                            <li><b>No Availability</b> <span>재고 없음</span></li>
                        		</c:when>
                        		<c:otherwise>
		                            <li><b>Availability</b> <span>${goodsDto.goodsCnt }개</span></li>
                        		</c:otherwise>
                        	</c:choose>
